...
description: "Use when writing or reviewing a README, docs, an RFC, a PR or MR description, or a commit message. Layers Diátaxis structure, Google developer style, STE instruction rules, Global English syntax."
---
